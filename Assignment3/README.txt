...
Extra credit: Compare the convergence of M,T and S methods against the more advanced Romberg Quadrature (C code is in the Implementation here https://en.wikipedia.org/wiki/Romberg%27s_method).
